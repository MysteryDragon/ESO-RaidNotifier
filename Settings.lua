...
--	}, "mawLorkhaj", "rakkhat_lunarbastion2")
	...
	MakeControlEntry({
		type = "dropdown",
		name = L.Settings_SanityEdge_Chimera_Meteor,
		tooltip = L.Settings_SanityEdge_Chimera_Meteor_TT,
		choices = choices.sanityEdge.chimera_meteor,
	}, "sanityEdge", "chimera_meteor")
	MakeControlEntry({
		type = "dropdown",
